...
function Module13($Epage){
	if($Epage == "1131"){

print'
<h1>Information Sensitivity</h1>
<br>
<b>The objectives of this module are as follows:</b><br>
<ul>
<li>To explain the principles of information sensitivity
<li>To explain the process classifying, marking, handling, access to, downgrading, declassification and destruction of sensitive information.
</ul>
<br>
<b>The module is aimed at the following groups:</b><br>
<ul>
<li>Records Clerks (who will process records containing sensitive information)
<li>Records Officers/Managers (who will manage records containing sensitive information)
</ul>
<br>
<b>The module covers the following topics:</b><br>
<ul>
<li>What is information sensitivity and how does it relate to United Nations records?
<li>When and who classifies sensitive information.
<li>How to mark sensitive information.
<li>The requirements for access to sensitive information.
<li>The handling of sensitive information.
<li>The downgrading, declassification and destruction of sensitive information.
</ul>
<br>
<h2><u><strong>Information Sensitivity</strong></u></h2>
		<ul>
			<li><strong><a href="/ARMS/node/29?Epage=1132">What is Information Sensitivity and how does it relate to United Nations records?</a></strong></li>
			<li><strong><a href="/ARMS/node/29?Epage=1133">Security Classification Principles?</a></strong></li>
			<li><strong><a href="/ARMS/node/29?Epage=1134">Classification and Marking</a></strong></li>
			<li><strong><a href="/ARMS/node/29?Epage=1135">Access to and Declassification of Sensitive Information</a></strong></li>
			<li><strong><a href="/ARMS/node/29?Epage=1136">Handling Sensitive Information</a></strong></li>
		</ul>';
	}else if ($Epage == "1132"){
	print'
<h1>What is Information Sensitivity and how does it relate to United Nations records?</h1>
<br>
...
<br>
Information sensitivity and security are often extremely difficult to manage even under the best conditions, particularly in light of recent increases in both electronic information and the demand for instantaneous access to this information. These challenges are magnified within UN field operations due to the unique nature of each mission / field office and the exceptional circumstances in which they operate. Nevertheless, the need for and requirements related to managing sensitive information are not dismissed because of these challenges.<br>
<br>
It is necessary that all staff members are aware of their responsibilities to protect records and information. The Secretary-General\'s Bulletin <a href="http://archives.un.org/unarms/doc/ST_SGB_2007_6_eng.pdf" target="_blank">ST/SGB/2007/6 - Information sensitivity, classification and handling</a> on information sensitivity, classification and handling establishes baseline United Nations policy and responsibilities on these matters. <a href="/ARMS/node/22">The Information Sensitivity Toolkit</a>, used in conjunction with training, provides the requirements and means for staff members to manage sensitive records to ensure protection of the confidentiality and integrity of information contained therein, thereby meeting the requirements of ST/SGB/2007/6. The proper handling and protection of sensitive records will ensure that unauthorized disclosures are averted, thereby protecting operational integrity and the safety of staff members, United Nations partners, and local populations. <br>
<br>
<br> 
The Information Sensitivity Toolkit provides easy to understand guidance on a number of topics relating to information sensitivity and security, including:<br>
<ul>
<li>United Nations security classification principles and levels,
<li>When and who classifies information,
<li>How to mark sensitive information,
<li>The requirements for access to information, 
<li>The handling of sensitive information, and
<li>The downgrading, declassification and destruction of sensitive information.
<ul>	
<br>
<h2><u><strong>Information Sensitivity</strong></u></h2>
	...
	print'
	<h1>Security Classification Principles</h1>
<br>
Classification is the act or process by which information is determined to be sensitive or non-sensitive. Classifying information properly is one of the core components of information security. Per ST/SGB/2007/6, the three official United Nations security classifications are: STRICTLY CONFIDENTIAL, CONFIDENTIAL and UNCLASSIFIED. <br>
<br>
The overall approach to classifying information within the United Nations is that work should be open and transparent to the extent appropriate based on the sensitivity of the information. Accordingly, information should only be classified as STRICTLY CONFIDENTIAL or CONFIDENTIAL where disclosure would be detrimental to the proper functioning of the United Nations, endanger the welfare and safety of its staff or third parties, or violate legal obligations.<br>
<br>
<b>Security Classification Principles - Quiz</b><br><br>
		<b>1. A record bearing a security classification of \'Unclassified\' is releasable to the public</b>
...
False
		...
		<br>
<b>2. A record bearing a security classification of \'Confidential\' is automatically declassified after 20 years</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>3. \'Public\' is an official United Nations security classification</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
False
		...
		<br>
<b>4. All staff member personal information - including time and attendance - should be considered \'Strictly Confidential\'</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>5. Contractual information between the United Nations and a 3rd party is not considered sensitive</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
<h2><u><strong>Information Sensitivity</strong></u></h2>
	...
	print'
<h1>Classification and Marking</h1>
<br>
The classification principles mentioned in the previous section draw a basic distinction between sensitive information (which requires a marking of STRICTLY CONFIDENTIAL or CONFIDENTIAL) and non-sensitive yet internal information (which justifies a marking of UNCLASSIFIED). To draw a further distinction between STRICTLY CONFIDENTIAL, CONFIDENTIAL and UNCLASSIFIED, one must also look at the degree of sensitivity of the information at hand.<br>
<br>
Records should be marked for the highest level of security classification of the information contained therein. The entire record will be marked for the highest level of sensitive information. The following basic marking requirements should be used on all records with a security classification of STRICTLY CONFIDENTIAL, CONFIDENTIAL or UNCLASSIFIED. Wherever possible, electronic templates containing these three options should be used in the drafting process.<br>
<br>
<b>Classification and Marking - Quiz</b><br><br>
		<b>1. A record received from a 3rd party bearing a non-UN security classification must always be given a UN security classification that provides the record with equal or greater protection</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
False
		...
		<br>
<b>2. Recipients of information from other departments or offices should verify the security classification against record contents prior to further distribution</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>3. A folder should bear the security classification of the highest security classification found in the folder contents</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>4. Sensitive information does not require a marking of \'Confidential\' or \'Strictly Confidential\' until it is approved or signed</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
False
		...
		<br>
<b>5. Any staff member can classify and mark information he or she has created as \'Unclassified\'</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>2. A staff member has the right to access his or her official status file</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>3. Unauthorized disclosure of sensitive information to third parties is considered as a form of misconduct</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>4. Unauthorized disclosure of sensitive information to United Nations colleagues is considered as a form of misconduct</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
False
		...
		<br>
<b>5. United Nations partners may have access to certain information provided that the originator of the information approves, the partner has a need to know, and the partner will ensure that the information is safeguarded</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>2. Although Unclassified records are not considered sensitive, they should be protected from unauthorized disclosure outside the United Nations</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>3. Sensitive information may be transmitted via standard fax</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
False
		...
		<br>
<b>4. Unclassified information may be stored on open shelving, provided that the shelving is in an area under United Nations control</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
...
True
		...
		<br>
<b>5. Under all circumstances, sensitive information may be transmitted via email as long as the email is encrypted</b>
		<SELECT class="RightButt"  >
			<OPTION VALUE="0"  SELECTED> </OPTION>
			<OPTION VALUE="1"  >True</OPTION>
			<OPTION VALUE="2"  >False </OPTION>
